...
- (NSArray *)allEvents{
    ...
    NSDate* ssdate = [NSDate dateWithTimeIntervalSinceNow:-3600*24*15];
    NSDate* ssend = [NSDate dateWithTimeIntervalSinceNow:3600*24*15];
...
- (BOOL)createEventWithContent:(NSString *)content local:(NSString *)location{
    ...
    event.endDate   = [NSDate dateWithTimeIntervalSinceNow:3600*3];
    event.allDay = NO;
